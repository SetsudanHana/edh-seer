...
import { buildAbilityMessages } from "../../packages/tagger/src/llm/prompt.js";
import type { ChatMessage } from "../../packages/tagger/src/llm/provider.js";
import { docToCard } from "@edh-seer/data";

const OUT = process.argv[2] ?? scratchDir("schema-exp");
