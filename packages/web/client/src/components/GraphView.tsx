...
import {
  CARD_MODE_Z, MAX_Z, cardImageUrl, renderModeFor, shouldPrefetchCard,
} from "./card-node.js";
import {
  FLOW_EVENT_HUES, OVERFLOW_HUE, PAINT_MODES, paintHues, paintLegend, subcategoryLabel,
} from "./presets.js";
import { computeFlow, type Flow } from "./flow.js";
import { eventLabel, mechanismKey } from "../lib/demand-sentence.js";
import {
  ART_RADIUS, CARD_H, CARD_W, DEFAULT_PARAMS, linkDistanceFor, nodeRadius, PARK_ALPHA, type BoardParams, type Sim,
} from "./board-force.js";
...
import { LABEL_PX, paintBoard, type Point } from "./board-paint.js";
...
export function GraphView(
  ...
  useEffect(() => {
    ...
    // The nodes, links and simulation for this graph; see board-model.ts.
    const {
      isFirstLayout, neighborsOf, nodes, byId, links, undrawnLinks,
      tagsByPair, weightedDegree, maxWeight, facePairLinks, simulation,
    } = buildBoardModel(graph, params, bare, prevPositions);
    ...
    // One frame; see board-paint.ts. Built per call so `dim` and every ref are read as they are now.
    const draw = () => paintBoard({
