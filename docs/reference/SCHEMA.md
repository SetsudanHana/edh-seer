...
|---|---|---|
| `NORMALIZE_VERSION` | **17** | Bump when ANYTHING that determines the request changes: SYSTEM, VERBS, TRIGGERS, ZONES — and `segment.ts`, because the segmenter decides which clauses exist and what ids they carry. |
